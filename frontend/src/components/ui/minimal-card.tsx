...
>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[24px] bg-slate-950/50 hover:bg-slate-950/70 p-6 no-underline shadow-sm transition-colors border border-white/5 text-slate-100",
      "shadow-[0px_1px_1px_0px_rgba(0,0,0,0.2),0px_1px_1px_0px_rgba(0,0,0,0.3)_inset,0px_0px_0px_1px_hsla(0,0%,0%,0.2)_inset,0px_0px_1px_0px_rgba(255,255,255,0.1)]",
      className
    )}
    {...props}
  >
